...
export const Definitions = {
  ...
  session_parent: keybind("none", "Go to parent session"),
  ...
  session_cycle_recent: keybind("up", "Cycle to the previous recent session or go to parent"),
  session_cycle_recent_reverse: keybind("down", "Cycle to the next recent session or go to first child"),
  ...
  messages_next: keybind("<leader>j", "Navigate to next message"),
  messages_previous: keybind("<leader>k", "Navigate to previous message"),
  ...
  tool_details: keybind("<leader>d", "Toggle tool details visibility"),
  display_thinking: keybind("<leader>i", "Toggle thinking blocks visibility"),
  tool_expand_toggle: keybind("<leader>z", "Expand or collapse tool outputs"),
...
export const CommandMap = {
  ...
  tool_expand_toggle: "session.toggle.expand",
